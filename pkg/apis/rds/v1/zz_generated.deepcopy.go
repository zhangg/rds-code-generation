...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MysqlSpeccc) DeepCopyInto(out *MysqlSpeccc) {
	*out = *in
	if in.Port != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MysqlSpeccc.
func (in *MysqlSpeccc) DeepCopy() *MysqlSpeccc {
	if in == nil {
		return nil
	}
	out := new(MysqlSpeccc)
